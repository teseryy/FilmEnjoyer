...
class ActorServiceImplIntegrationTest {
    ...
    void setUp(){
        ...
        actor = new Actor(150L, "testName", "testSurname", new Date(103, 10, 30), new ArrayList<>());
        film = new Film(500L, "testTitle", 160, "Nolan", new Date(123, 10, 30), 100, "USA", new ArrayList<>(), new ArrayList<>());
